...
namespace Teretana
{
    ...
    /// </summary>
    public sealed partial class TrainerMenu : Page
    {
        public TrainerMenu()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            using (var db = new AppDBContext())
            {
                ...
                trainerMenuFrame = currentFrame;
            }
        }

        public static Frame trainerMenuFrame;
        private User user;
        private int id;
        private void trainerPivotSelection(object sender, SelectionChangedEventArgs e)
        {
            if (PivotTab.SelectedIndex == 0)
            {
                currentFrame.Navigate(typeof(TrainingSessionsView));
            }
            else if (PivotTab.SelectedIndex == 1)
            {
                currentFrame.Navigate(typeof(MembersView));
            }
            else
            {
                currentFrame.Navigate(typeof(SalesView));
            }
        }
